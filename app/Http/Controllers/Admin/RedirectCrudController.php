...
class RedirectCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('301 редирект', '301 редирект');
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::addColumn(['name' => 'redirect_from', 'type' => 'text','label'=>'Редирект с ']);
        CRUD::addColumn(['name' => 'redirect_to', 'type' => 'text','label'=>'Редирект на ']);
        /**
